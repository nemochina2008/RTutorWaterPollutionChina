...
$$
ln\_digestive_i = \beta_1 \cdot water\_qlty_i + \gamma_1 \cdot region\_east + \gamma_2 \cdot region\_west + u_i.
$$

We make the following three observations:

- The region dummies are not indexed by $i$ since they do not depend on the DSP site but are constants.
...
The cost of averting a death is considerably smaller than the estimated value of a life of a Chinese citizen. We can conclude that the cost of saving a life through wastewater cleanup is justified due to the benefit in improved health conditions.
